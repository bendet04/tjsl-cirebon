...
var url = "<?php echo site_url('skpd/jenis_permohonan/') ?>";
</script>
<!-- Start Page Content -->
<!-- ============================================================== -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Data  Jenis Permohonan</h4>
                ...
                <div class="table-responsive m-t-10">
                    <table id="jenis_permohonan" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                            <th>ID </th>
...
<div class="modal" id="modal_jenis_permohonan" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <?php  echo form_open('', 'id="form_jenis_permohonan"'); ?>
