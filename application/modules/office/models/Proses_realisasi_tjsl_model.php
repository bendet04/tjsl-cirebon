...
class Proses_realisasi_tjsl_model extends MY_Model
    {
        ...
        public function get_all_proses_realisasi_tjsl()
        {
            ...
            foreach ($data as $row) {
                ...
                if($row->status_permohonan == 0){
                 ...
                 if($row->status_realisasi == 0){
                    $array[] = $status_realisasi  .' | '. $realisasi;
                 }else{
                    $array[] = $status_realisasi  .' | '. $batal;
                 }
        ...
        public function get_proses_realisasi_tjsl($id = '')
        {
            // print_r($id);die();
