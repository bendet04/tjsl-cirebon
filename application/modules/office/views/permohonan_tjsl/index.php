...
var url = "<?php echo site_url('office/permohonan_tjsl/') ?>";
</script>
<!-- Start Page Content -->
<!-- ============================================================== -->
<div class="row">
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <input type="text" id="id_realisasi" class="form-control">
        <br>
...
<!-- <div class="modal" id="modal_confirm_realisasi" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-body">
         <input type="text" name="permohonan_tjsl_id" id="permohonan_tjsl_id" class="form-control">
        <br>
...
<!-- ////////////////// modal buat confirm setujui -->
<div class="modal" id="modal_confirm_setujui" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
  <div class="modal-dialog modal-md">

    <div class="modal-content">
      <div class="modal-body">
        <center><p>Yakin Mau Menyetujui Permohonan TJSL ini?</p></center>
        <input type="hidden" id="id_setujui" class="form-control">
        <br>
        <!-- <input type="text" name="jumlah_bayar" id="jumlah_bayar" class="form-control" placeholder="jumlah bayar"> -->
      </div>
      <div class="modal-footer">
        <button type="button" id="confirm_setujui" class="btn btn-danger"  data-dismiss="modal">Ya</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
      </div>
    </div>
...
<!-- ////////////////// modal buat confirm tolak -->
<div class="modal" id="modal_confirm_tolak" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
  <div class="modal-dialog modal-md">

    <div class="modal-content">
      <div class="modal-body">
        <center><p>Yakin Mau Menolak Permohonan TJSL ini?</p></center>
        <input type="hidden" id="id_tolak" class="form-control">
        <br>
        <!-- <input type="text" name="jumlah_bayar" id="jumlah_bayar" class="form-control" placeholder="jumlah bayar"> -->
      </div>
      <div class="modal-footer">
        <button type="button" id="confirm_tolak" class="btn btn-danger"  data-dismiss="modal">Ya</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Tidak</button>
      </div>
    </div>
...
<div class="modal" id="modal_confirm_batal" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-body">
        <center><p>Yakin Mau Batalkan Verifikasinya?</p></center>
