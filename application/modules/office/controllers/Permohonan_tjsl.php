...
class Permohonan_tjsl extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        Assets::add_module_js('office', 'js_permohonan_tjsl.js');
    }
    ...
    public function setujui()
    {
        ...
        if (!$this->input->post('id')) {
            ...
            if ($save) {
                $result['status'] = 'success';
                $result['heading'] = 'Selamat Proses Berhasil';
                $result['msg']    = 'Permohonan TJSL Berhasil Disetujui!';
...
// Batalkan
    ...
    //                 //         'status'      => 1,
    //                 //         );
    //                 //     $update = $this->perusahaan_model->update($this->input->post('permohonan_tjsl_id'),$data_update);
    //                 //     if ($update) {
    //                 //     $result['status'] = 'success';
    //                 //     $result['heading'] = 'Selamat Proses Berhasil';
