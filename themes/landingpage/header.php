...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" id="theme" href="<?php echo base_url('themes/landingpage/') ?>assets/images/favicon.png">
    <title>TJSL Cirebon</title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- Custom CSS -->
    <link id="theme" href="<?php echo base_url('themes/landingpage/') ?>assets/css/style.css" rel="stylesheet">
